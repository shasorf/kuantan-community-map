...
var format_OCEAN_1 = new ol.format.GeoJSON();
var features_OCEAN_1 = format_OCEAN_1.readFeatures(json_OCEAN_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_OCEAN_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_OCEAN_1.addFeatures(features_OCEAN_1);
var lyr_OCEAN_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_OCEAN_1, 
                style: style_OCEAN_1,
                popuplayertitle: 'OCEAN',
                interactive: true,
                title: '<img src="styles/legend/OCEAN_1.png" /> OCEAN'
            });
...
lyr_OCEAN_1.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'natural': 'natural', 'leisure': 'leisure', 'golf': 'golf', 'place': 'place', 'name:en': 'name:en', 'name': 'name', 'reservoir_type': 'reservoir_type', 'water': 'water', 'type': 'type', 'waterway': 'waterway', });
...
lyr_OCEAN_1.set('fieldImages', {'fid': '', 'full_id': '', 'osm_id': '', 'osm_type': '', 'natural': '', 'leisure': '', 'golf': '', 'place': '', 'name:en': '', 'name': '', 'reservoir_type': '', 'water': '', 'type': '', 'waterway': '', });
